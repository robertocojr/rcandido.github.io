...
<section id="motion" class="xfixwidth ">
    <video loop="" id="motionv" style="position:fixed;display:block;margin:0 auto;height:auto;z-index: -1;margin-left: -292px;margin-top: -170px;">
...
<script>
  ...
  vid.load();
  vid.play();
  //Redimenciona o vídeo.
  var windowWidth = window.innerWidth;
  var windowHeight = window.innerHeight;
  $('#motionv').width = windowWidth;
  $('#motionv').height = windowHeight;
</script>
